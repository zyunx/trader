...
import net.zyunx.trader.model.xgb.TopPlateId;
import net.zyunx.trader.model.xgb.TopPlateRepository;
import net.zyunx.trader.model.xgb.TopPlateResponse;
import net.zyunx.trader.model.xgb.TopStock;
import net.zyunx.trader.model.xgb.TopStockRepository;
...
public class XgbController {
    ...
    @PostMapping(value="/")
    public void crawlXgbPlate(@RequestBody FetchXgbTopPlateCommand command) throws JsonMappingException, JsonProcessingException {
